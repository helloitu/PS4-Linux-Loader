# PS4 Linux Loader
A simple payload that let you run Linux on your 5.05 PS4, updated by me, with updated offsets. 
...
For debug the payload while running go to file source/main.c on line 97 and custom insert your pc ip
after this, when the payload are initialized you will receive some debug messages.


## How to use

You need a FAT32 formatted USB drive plugged in the closest drive PS4's USB port  with the following files on the root directory : bzImage and initramfs.cpio.gz. You can download [them here](https://mega.nz/#!hEh1QI4B!gCDA5l7GyTekQ-fURvKw6WRieSbHETb3tYHb--SkmhM).
